...
int main(void) {
    ...
    // 1 => true, 0 => false
    if (check_stock(order, inventory)) {
    ...
    // due to the life cycle, if we make any changes in the function
    // will not change in main function
    // so we need to update our old one
